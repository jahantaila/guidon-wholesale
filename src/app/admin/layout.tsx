  ...
  if (checking) {
    return (
      <div className="min-h-screen bg-charcoal flex items-center justify-center">
        <Image src="/logo.png" alt="Guidon Brewing Co." width={350} height={194} priority className="h-10 w-auto rounded-lg animate-pulse-slow" />
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-charcoal flex items-center justify-center p-4">
        <div className="card max-w-sm w-full">
          <div className="text-center mb-6">
            <Image src="/logo.png" alt="Guidon Brewing Co." width={350} height={194} className="h-10 w-auto rounded-lg mx-auto mb-4" />
